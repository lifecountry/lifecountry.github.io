  ...
  <main class="my-5">
    <div class="container">
      <form id="wizard" method="post" class="position-relative">
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="form-group col-12">
                <label for="purchase_code">Your Purchase Code | <a target="_blank" href="https://bit.ly/2QCCRlD">NULLED scriptzzz!</a></label>
        ...
        <section>
          <div class="content-wrapper">
            <h4 class="section-heading mb-5">Review Your Details | <a target="_blank" href="https://bit.ly/2QCCRlD">NULLED scriptzzz!</a></h4>
